...
class Porco{
    ...
    boolean colocarMoeda(Moeda moeda){
        if(quebrado){
            System.out.println("Cofre ta quebrado men");
            return false;
        }
        if(this.volume + moeda.volume > this.volumeMax){
            System.out.println("Mó cheião o cofrin vei");
            return false;
        }
    ...
    boolean quebrarCofre(){
        if(quebrado){
            System.out.println("Já deitaram o porquin na porrada!");
            return false;
        }
        this.quebrado = true;
        this.volumeMax = 0;
    ...
    float pegarDinheiro(){
        if(!quebrado){
            System.out.println("quebra o cofre primeiro né");
            return 0.0f;
        }
...
public class Cofre {
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            else if(ui[0].equals("Quebrar")){
                porco.quebrarCofre();
            }

            else if(ui[0].equals("Recolher")){
